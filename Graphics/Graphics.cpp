...
//
//			// Intilize Index/Vertex buffer + Shaders
//			streamlineRenderer.initialize();
//			this->streamlineRenderer.initialize();
...
//			this->streamlineRenderer.cleanPipeline();
//		}
//
//
//	
...
void Graphics::RenderFrame()
{
	...
	this->streamlineRenderer.initilizeRasterizer();
	this->streamlineRenderer.setShaders();
	//this->deviceContext->IASetInputLayout(this->streamlineRenderer.vertexshader.GetInputLayout());		// Set the input layout
	...
	//this->deviceContext->VSSetShader(streamlineRenderer.vertexshader.GetShader(), NULL, 0);			// set vertex shader
	//this->deviceContext->PSSetShader(streamlineRenderer.pixelshader.GetShader(), NULL, 0);				// set pixel shader
	...
	{
		// Set Geometry shader
		//this->deviceContext->GSSetShader(streamlineRenderer.geometryshader.GetShader(), NULL, 0);
