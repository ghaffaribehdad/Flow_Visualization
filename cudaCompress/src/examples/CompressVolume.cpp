...
void decompressVolumeFloat(GPUResources& shared, CompressVolumeResources& resources, float* dpImage, uint sizeX, uint sizeY, uint sizeZ, uint numLevels, const std::vector<uint>& bits, float quantizationStepLevel0, size_t bufferSize,bool doRLEOnlyOnLvl0)
{
    decompressVolumeFloat(shared, resources, dpImage, sizeX, sizeY, sizeZ, numLevels, bits.data(), bufferSize, quantizationStepLevel0, doRLEOnlyOnLvl0);
}
